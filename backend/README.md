...
## Project Structure
    ...
    ├── testapiautocatalog_123050  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_123050`
...
2. Clone this repo and `cd testapiautocatalog_123050`
